#
# Cookbook Name:: gameclosure-devkit
# Attributes:: gameclosure-devkit
#

default['gameclosure-devkit']['install_url'] = 'https://install.meteor.com'
default['gameclosure-devkit']['install_meteorite'] = true # http://oortcloud.github.com/meteorite/
default['gameclosure-devkit']['install_mongodb'] = true
